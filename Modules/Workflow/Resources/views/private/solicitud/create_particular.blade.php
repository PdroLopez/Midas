						...
						<div class="card-body p-0">
							<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
								<div class="col-xl-12 col-xxl-7">
									<!--begin: Wizard Form-->
									<form class="form mt-0 mt-lg-10" id="kt_form" method="post" action="{{ asset('workflow/agregar-solicitud') }}" file="true"  enctype="multipart/form-data">
										<!--begin: Wizard Step 1-->
										@csrf
										...
										@include('workflow::private.solicitud.productos_particulares')
										<div class="form-group">
				              ...
				              ?>
					            ...
					            @endif
											...
											<div class="form-group">
					                            ...
					                            <textarea class="form-control" name="comentario" id="comentarioparticular"></textarea>
                                            </div>
					                        <div class="form-group">
					                        	<label>Fotos</label>
...
<script>
	...
	function borrarproducto(id_sol){
		$.get("{{ asset('/workflow/borrar-producto') }}/"+id_sol,function(data, status) {
			var tabla = `<thead>
                    <tr>
                        <th>Producto</th>
                        <th>Imagen</th>
