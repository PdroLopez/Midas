                ...
                <div class="d-flex align-items-baseline mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">Ordenes de Trabajo</a>
                        </li>
                    </ul>
                        ...
                        <div class="card-body px-5">
                            ...
                            <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                                ...
                                <div class="navi-item my-2">
                                    <a href="{{ asset('workflow/') }}" class="navi-link">
                                ...
                                <!--begin::Item-->
                                <div class="navi-item my-2">
                                    <a href="{{ asset('workflow/datos-proceso') }}" class="navi-link active">
                                        <span class="navi-icon mr-4">
                                            <span class="svg-icon svg-icon-lg">
                                        ...
                                        <span class="navi-label">
                                            <span class="label label-rounded label-light-warning font-weight-bolder">{{ count($total) }}</span>
                                        </span>
                                    </a>
                                </div>
                            	...
                            	<tbody>
                                    ...
                                    ?>
                                		<tr>
                                				...
                                				<div class="dropdown dropdown-inline mr-2">
    												...
    												<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
    													<ul class="nav flex-column nav-hover">
                                                            ...
                                                            @if ($boleta->estado->id == 28)

                                                            <li class="nav-item">
                                                                <a href="{{ asset('workflow/pesaje/'.$boleta->id) }}" class="nav-link" target="_blank">
                                                                    <span class="nav-text">Pesar</span>
                                                                </a>
                                                            </li>
                                                           @endif
                                                          ...
                                                          <li class="nav-item">
                                                              <a href="{{ asset('workflow/en-planta/'.$boleta->id) }}" onclick="return confirm('¿Esta seguro de querer cambiar el estado a En planta?');"
                                                               class="nav-link">
                                                         ...
                                                         @endif
                                                          ...
                                                          @if ($boleta->estado->id == 9 )


                                                          <li class="nav-item">
                                                              <a {{-- href="{{ asset('workflow/retirado/'.$boleta->id) }}" onclick="return confirm('¿Esta seguro de querer cambiar el estado a Retirado?');" --}} class="nav-link" data-toggle="modal" data-target="#retiro{{ $boleta->id }}">
                                                                  <span class="nav-text">Retirado</span>
                                                              </a>
                                                          </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="modal" data-target="#cancelar{{ $boleta->id }}">
                                                                    <i class="nav-icon la la-file-excel-o"></i>
                                                                    <span class="nav-text">Cancelar retiro</span>
                                                                </a>
                                                            </li>
                                                        <li class="nav-item">
                                                            <a href="{{ asset('workflow/programacion/'.$boleta->id) }}" data-toggle="modal" data-target="#Programar{{$boleta->id}}" class="nav-link">
                                                                <span class="nav-text">Re-Programar</span>
                                                            </a>
                                                        </li>
                                                         @endif
                                                            @if($boleta->estado->id == 30)
    														<li class="nav-item">
                                                            ...
                                                            @if($boleta->estado->id == 29)
                                                                @if($boleta->calidad->where('sl_tipo_imagen_id',4)->count() == 0)
                                                                    <li class="nav-item">
                                                                ...
                                                                @endif
                                                            <li class="nav-item">
                                                                <a href="{{ asset('workflow/procesar/'.$boleta->id) }}" class="nav-link">
    														...
    														<li class="nav-item">
    															<a href="{{ asset('workflow/cancelar/'.$boleta->id) }}" class="nav-link" onclick="return confirm('¿Esta seguro de querer cancelar este retiro?');">
                                            ...
                                            @include('workflow::private.cancelar')
                                            @include('workflow::private.retirado')
                                		</tr>
                                    @endforeach
                            	</tbody>
                            </table>
