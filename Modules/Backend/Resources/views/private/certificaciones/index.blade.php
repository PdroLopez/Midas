    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Certificaciones</h3>
                <div class="ml-10">@include('backend::private.certificaciones.create')</div>
            </div>
        </div>
        <div class="card-body">
            <div class="mb-7">
                        ...
                        @foreach ($certificado as $certificados)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @include('backend::private.certificaciones.destroy')
                                </td>
                                @include('backend::private.certificaciones.edit')
                            </tr>
                        @endforeach
