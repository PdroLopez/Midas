...
@section('content')
    <div class="mb-20">
        ...
        <form method="POST" action="{{ asset('login/register/agregar-user-instagram') }}">
            @csrf
            <div class="form-group mb-5">
                <input id="nombre_instagram" type="text" class="form-control h-auto form-control-solid py-4 px-8" name="nombre_instagram" placeholder="Nombre Instagram" required autocomplete="Nombre Instagram" autofocus value="{{ Session::get('datos_instagram')['name'] }}">
            </div>
            <div class="form-group mb-5">
