...
@section('content')
    <div class="mb-20">
        ...
        <form method="POST" action="{{ asset('login/register/agregar-user') }}">
            @csrf
            <div class="form-group mb-5">
                <input id="name" type="text" class="form-control h-auto form-control-solid py-4 px-8" name="name" placeholder="Nombre" required autocomplete="name" autofocus value="{{ Session::get('datos_socialite')['name'] }}">
            </div>
            @if(Session::get('datos_socialite')['email'] != null)
            <div class="form-group mb-5">
                <input id="email" type="email" class="form-control h-auto form-control-solid py-4 px-8" name="email" placeholder="Email" required autocomplete="email" value="{{ Session::get('datos_socialite')['email'] }}">
            </div>
            @else
            <div class="form-group mb-5">
            ...
            <div class="form-group mb-5">
                <input id="telefono" type="number" class="form-control h-auto form-control-solid py-4 px-8" name="telefono" placeholder="9 12345678" required autocomplete="telefono" autofocus>
            </div>
