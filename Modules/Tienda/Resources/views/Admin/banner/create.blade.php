...
<button class="btn btn-primary" data-toggle="modal" data-target="#create">Agregar Banner <i class="fas fa-plus"></i></button>

<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="create" role="dialog" tabindex="-1">
    <div class="modal-dialog" role="document">
        {!!Form::open(['route' => 'mantenedor-banner.store', 'method' => 'POST','files'=>true])!!}
