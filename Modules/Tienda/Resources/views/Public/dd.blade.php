					...
					<div class="wizard wizard-1" id="kt_wizard_v1" data-wizard-state="step-first" data-wizard-clickable="false">
						<div class="wizard-nav border-bottom">
							<div class="wizard-steps p-8 p-lg-10">
								<div class="wizard-step" data-wizard-type="step" id="direccion" data-wizard-state="current">
								...
								<form class="form" id="kt_form" action="{{ asset('tienda/final-compra') }}" method="post" files="true" enctype="multipart/form-data">
									...
									<div class="pb-5" data-wizard-type="step-content" data-wizard-state="paso-4" >
										...
										<div class="row">
										    ...
										    <div class="col-md-6">
										      	<input id="otro" type="radio" name="metododepago" value="otro" />
										     	<img src="https://i2.wp.com/www.metodosdepago.com/wp-content/uploads/metodos-de-pago-online.jpg?fit=640%2C300" style="width: 200px;">
										    </div>
										  </div>
									</div>
...
<script>
	function siguientecompra() {
        ...
        // alert(article.dataset.wizardState);

        // var contador=0;
        // let a = document.getElementById('myBtn').onclick = function() {
        //     contador++;
        //     document.getElementById('wizard4');
        //     if (contador == 2) {
        //         document.getElementById('btn-pagar').style.display = 'block';
        //     }
        //     else if(contador >3 )
