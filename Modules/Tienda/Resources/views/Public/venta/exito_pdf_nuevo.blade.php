                          ...
                          <font size="1">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <p style="text-transform:uppercase;">: {{ $transaccion->ventas_fuera->nombre }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                      <p style="text-transform:uppercase;">: {{ $transaccion->ventas_fuera->direccion }}  @if($transaccion->ventas_fuera->bk_comunas_id != null),{{$transaccion->ventas_fuera->comuna->nombre}} @endif @if($transaccion->ventas_fuera->bk_regiones_id != null), {{$transaccion->ventas_fuera->region->nombre}} @endif</p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <p style="text-transform:uppercase;">: {{ $transaccion->ventas_fuera->detalle }}</p>
                                    </td>
                                </tr>
                                @endif
                                <tr>
                              ...
                              @if ($transaccion->tran_venta->first()->venta->bk_despacho_id != null)
                                @if($transaccion->tran_venta->first()->venta->despacho->bk_cobertura_id == 1)
                                  <tr>
                                      ...
                                      <td style="width: 55px;text-align: right;">{{ $transaccion->tran_venta->first()->venta->despacho_valor}}</td>
                                  </tr>
                                @else
                                  <tr>
                                      <td style="text-align: right;"><b>COSTO DESPACHO:</b></td>
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 55px;text-transform:uppercase;text-align: right;">
                                      <p > {{ $transaccion->tran_venta->first()->venta->tipo_pago}}</p>
                                    </td>
                                </tr>
                                <tr>
