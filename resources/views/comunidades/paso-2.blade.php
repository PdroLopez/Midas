        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="row pb-10">
                ...
                <div class="col-6 text-left">
                    <a href="{{ asset('/crear-comunidad/paso-3') }}" class="btn btn-lg btn-primary btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2">Siguiente
                    </a>
                </div>
            </div>
        </div>
