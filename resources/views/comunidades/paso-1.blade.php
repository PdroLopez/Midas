        ...
        <div class="col-md-8 p-lg-5 mx-auto my-5">
            <div class="row">
                <div class="col-md-6 col-10">
                    <h1 class="display-4 font-weight-normal">Nueva Comunidad</h1>
                </div>
    ...
    <div class="container mt-md-20 mt-10 mb-0">
        <div class="card card-custom gutter-b">
            <div class="card-body pt-1">
                <h3 class="my-10">Elige tu comunidad</h3>
                <div class="row">
                    @foreach ($tipo as $tipo_comunidad)
                        <div class="col-md-4 col-sm-6 col-12 mb-8">
                            <a href="{{ asset('/crear-comunidad/'.$tipo_comunidad->nombre) }}">
                                <div class="card w-100 card-hover" style="width: 18rem;">
                                    <img class="card-img-top pt-10" src="{{ asset('img/reciclar.svg') }}" height="80">
                                    <div class="card-body">
                                        <h5 class="card-title text-center mb-0">{{ $tipo_comunidad->nombre }}</h5>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    {{--    
                           <div class="col-md-4 col-sm-6 col-12 mb-8">
                        <a href="{{ asset('/crear-comunidad/paso-2') }}">
                            <div class="card w-100 card-hover" style="width: 18rem;">
                                <img class="card-img-top pt-10" src="{{ asset('img/reciclar.svg') }}" height="80">
                                <div class="card-body">
                                    <h5 class="card-title text-center mb-0">Condominios</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 mb-8">
                        <a href="{{ asset('/crear-comunidad/paso-2') }}">
                            <div class="card w-100 card-hover" style="width: 18rem;">
                                <img class="card-img-top pt-10" src="{{ asset('img/reciclar.svg') }}" height="80">
                                <div class="card-body">
                                    <h5 class="card-title text-center mb-0">Colegios</h5>
                                </div>
                            </div>
                        </a>
                    </div><div class="col-md-4 col-sm-6 col-12 mb-8">
                        <a href="{{ asset('/crear-comunidad/paso-2') }}">
                            <div class="card w-100 card-hover" style="width: 18rem;">
                                <img class="card-img-top pt-10" src="{{ asset('img/reciclar.svg') }}" height="80">
                                <div class="card-body">
                                    <h5 class="card-title text-center mb-0">Condominios 2</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 mb-8">
                        <a href="{{ asset('/crear-comunidad/paso-2') }}">
                            <div class="card w-100 card-hover" style="width: 18rem;">
                                <img class="card-img-top pt-10" src="{{ asset('img/reciclar.svg') }}" height="80">
                                <div class="card-body">
                                    <h5 class="card-title text-center mb-0">Condominios 3</h5>
                                </div>
                            </div>
                        </a>
                    </div> --}}
            ...
            {{-- <div class="row pb-10">
                <div class="col-6 text-right">
                    <a href="#" class="btn btn-lg btn-light btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2">Cancelar
                    </a>
                </div>
                <div class="col-6 text-left">
                    <a href="{{ asset('/crear-comunidad/paso-2') }}" class="btn btn-lg btn-primary btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2">Siguiente
                    </a>
                </div>
            </div> --}}
        </div>
