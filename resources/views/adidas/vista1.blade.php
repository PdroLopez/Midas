		...
		<div role="main" class="main">
			<div class="container py-4 my-5">
				<div class="row justify-content-center text-center mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
					<div class="col-lg-8">
						<img alt="Porto" style="width:20%" src="https://picsum.photos/200/300">
						<img alt="Porto" style="width:20%" src="https://picsum.photos/200/300">
						<img alt="Porto" style="width:20%" src="https://picsum.photos/200/300">
					</div>
				</div>
			...
			<div class="container py-4 my-5">
				<div class="row justify-content-center text-center mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
					<div class="col-lg-8">
						<h2 class="font-weight-bold mb-3 mt-3">BIENVENIDOS</h2>
						<p class="text-6 text-color-dark line-height-7 negative-ls-1 px-5">INGRESA EL CÓDIGO DE TU BOLETA Y OBTENDRAS IMPORTANTE DESCUENTO</p>
						<a class="btn btn-outline btn-dark" style="font-size: 30px;text-align: center;width: 210px;height: 65px;" href="{{ asset('beneficio/adidas/paso-1') }}">CONTINUAR</a>
					</div>
				</div>
			</div>
		</div>
