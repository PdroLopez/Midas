...
<html class="side-header-hamburguer-sidebar side-header-hamburguer-sidebar-right side-header-hamburguer-sidebar-push side-header-hide side-header-right-no-reverse">
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="{{ asset('HTML/css/skins/skin-corporate-13.css') }}"> 
					...
					<div class="container-fluid">
						<div class="row align-items-center">
							<div class="col-9">
								<div class="py-4">
									<a href="#">
										<img alt="Porto" width="100" data-change-src="{{ asset('img/midas1.png') }}" src="{{ asset('img/logomidas.svg') }}">
									</a>
								</div>
							</div>
						...
						<div class="header-column flex-column justify-content-center h-100">
							...
							<div class="header-row flex-row justify-content-center py-5">
								<div class="header-logo">
									<a href="#">
										<img alt="Porto" width="100" src="{{ asset('img/midas.png') }}">
									</a>
								</div>
							</div>
							...
							<div class="header-row justify-content-end pb-3">
								...
								<p class="text-1 pt-3">2019 © Copyright, Midas Chile. Todos los derechos reservados</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 700, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-1 arrows-big' }, 'bullets': {'enable': false, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li class="slide-overlay slide-overlay-gradient slide-overlay-level-9" data-transition="fade">
								<img src="{{ asset('HTML/img/slides/slide-corporate-13-1.jpg') }}"  
									alt=""
								...
								<h1 class="tp-caption text-color-light font-weight-normal"
									...
									data-transform_in="y:[-50%];opacity:0;s:500;">Bienvenidos a </h1>
								...
								<div class="tp-caption d-none d-md-block"
									...
									data-y="center" data-voffset="['-92','-92','-92','-100']"><img src="img/slides/slide-white-line.png" alt=""></div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
									...
									data-letterspacing="0">MIDAS CHILE</div>
								...
								<div class="tp-caption font-weight-light text-color-light text-center ws-normal"
									...
									data-lineheight="['29','29','29','60']">Hoy la historia la escribimos nosotros.</div>
				...
				<div class="home-intro mb-0" id="home-intro">
					<div class="container">
						...
						<div class="row text-center">
							<div class="col">
								<p class="mb-0">
									Primera empresa de reciclaje de residuos en el mundo, que realiza su operación con energía renovable 100% compensada con paneles solares.
								</p>
							</div>
						</div>
								...
								<ul class="nav nav-tabs mb-3">
									<li class="nav-item active appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
										<a class="nav-link" href="#tabsNavigationSimpleIcons1" data-toggle="tab">
											...
											<h4 class="text-color-dark text-3 mb-0 pb-0 mt-2">Destrucción Certificada <br> de Productos</h4>
										</a>
									</li>
									<li class="nav-item appear-animation" data-appear-animation="fadeInLeftShorter">
										<a class="nav-link" href="#tabsNavigationSimpleIcons2" data-toggle="tab">
											...
											<h4 class="text-color-dark text-3 mb-0 pb-0 mt-2">Reciclaje de <br> Residuos</h4>
										</a>
									</li>
									<li class="nav-item appear-animation" data-appear-animation="fadeInRightShorter">
										<a class="nav-link" href="#tabsNavigationSimpleIcons3" data-toggle="tab">
											...
											<h4 class="text-color-dark text-3 mb-0 pb-0 mt-2">Almacenamiento y <br> transporte de residuos</h4>
										</a>
									</li>
									<li class="nav-item appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
										<a class="nav-link" href="#tabsNavigationSimpleIcons4" data-toggle="tab">
											...
											<h4 class="text-color-dark text-3 mb-0 pb-0 mt-2">Asesoría en <br> sustentabilidad</h4>
										</a>
									</li>
									<li class="nav-item appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
										<a class="nav-link" href="#tabsNavigationSimpleIcons5" data-toggle="tab">
											<span class="featured-boxes featured-boxes-style-6 p-0 m-0">
												<span class="featured-box featured-box-primary featured-box-effect-6 p-0 m-0">
													<span class="box-content p-0 m-0">
														<i class="icon-featured fas fa-adjust"></i>
											...
											<h4 class="text-color-dark text-3 mb-0 pb-0 mt-2">Puntos de Reciclaje en <br> colegios y empresas</h4>
										</a>
									</li>
									<li class="nav-item appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
										<a class="nav-link" href="#tabsNavigationSimpleIcons6" data-toggle="tab">
											<span class="featured-boxes featured-boxes-style-6 p-0 m-0">
												<span class="featured-box featured-box-primary featured-box-effect-6 p-0 m-0">
													<span class="box-content p-0 m-0">
														<i class="icon-featured fas fa-adjust"></i>
											...
											<h4 class="text-color-dark text-3 mb-0 pb-0 mt-2">Operación <br> sustentable</h4>
										</a>
									</li>
								</ul>
				...
				<div class="container">
					<div class="row py-4 my-5">
						<div class="col py-3">
							<div class="owl-carousel owl-theme mb-0" data-plugin-options="{'responsive': {'0': {'items': 2}, '476': {'items': 2}, '768': {'items': 3}, '992': {'items': 4}, '1200': {'items': 4}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
								<div>
									<img class="img-fluid opacity-2" style="width: 100px;height: 100px;" src="{{ asset('img/Icono-1.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" style="width: 100px;height: 100px;" src="{{ asset('img/Icono-2.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" style="width: 200px;height: 100px;" src="{{ asset('img/Icono-3.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" style="width: 100px;height: 100px;" src="{{ asset('img/Icono-4.png') }}" alt="">
								</div>
							</div>
						...
						<div class="row align-items-center text-center text-md-left">
							...
							<div class="col-md-6 col-lg-5 offset-lg-1 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
								<div class="owl-carousel owl-theme nav-style-1 stage-margin mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 1}, '992': {'items': 1}, '1200': {'items': 1}}, 'margin': 25, 'loop': true, 'nav': true, 'dots': false, 'stagePadding': 40}">
									<div class="p-4">
										<img class="img-fluid box-shadow-3 mb-3" src="{{ asset('HTML/img/gallery/gallery-6.jpg') }}" alt="" />
									</div>
									<div class="p-4">
										<img class="img-fluid box-shadow-3 mb-3" src="{{ asset('HTML/img/gallery/gallery-7.jpg') }}" alt="" />
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="row py-5 my-5">
						<div class="col-md-6 mb-5 mb-md-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
							<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-dark testimonial-remove-right-quote mb-0">
								<div class="testimonial-author">
									<img src="{{ asset('HTML/img/clients/client-1.jpg') }}" class="img-fluid rounded-circle mb-0" alt="">
								</div>
								<blockquote>
								...
								<div class="testimonial-author">
									<p><strong class="font-weight-extra-bold text-3 mb-1">Cliente</strong><span>Santiago</span></p>
								</div>
							</div>
						</div>
						<div class="col-md-6 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
							<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-dark testimonial-remove-right-quote mb-0">
								<div class="testimonial-author">
									<img src="{{ asset('HTML/img/clients/client-2.jpg') }}" class="img-fluid rounded-circle mb-0" alt="">
								</div>
								<blockquote>
				...
				<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13335.083347195547!2d-70.73584493247903!3d-33.324806098461124!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9662bf571469cf75%3A0xdf8f12892724bb91!2sMidas%20Chile!5e0!3m2!1ses-419!2scl!4v1601585845561!5m2!1ses-419!2scl" frameborder="0" style="border:0;width: 100% !important;min-height: 550px;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
				</div>
				...
				<div class="container">
					<div class="row py-5 justify-content-center">
						...
						<div class="col-md-4 col-lg-3 mb-4 mb-lg-0 text-center text-lg-right">
							<h5 class="text-3 mb-0 pb-1 opacity-6">CONTACTO</h5>
							<p class="text-4 text-color-light font-weight-bold pb-1 mb-0">+56 2 2747 1487 | +56 2 2738 6045</p>
							<p class="m-0"><a href="mailto:contacto@midaschile.cl">contacto@midaschile.cl</a></p>
						</div>
					</div>
				</div>
						...
						<div class="row py-4">
							<div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
								<a href="index.html" class="logo pr-0 pr-lg-3">
									<img alt="" src="{{ asset('img/logomidas.svg') }}" width="100">
								</a>
							</div>
