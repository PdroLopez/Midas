            ...
            <div class="row pb-10">
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ asset('/') }}" class="btn btn-lg btn-primary btn-fixed-height font-weight-bold px-2 px-lg-5 mr-10" style="color: #FFFFFF;background-color: red;border-color: red;">Finalizar</a>
                    </div>
                </div>
            </div>
        </div>
