        ...
        <div class="col-md-8 p-lg-5 mx-auto my-5">
            <div class="row">
                <div class="col-md-6 col-10">
                    <h1 class="display-4 font-weight-normal">Agregar Dirección</h1>
                </div>
...
<form action="{{ asset('agregar-direccion') }}" method="post" files="true" enctype="multipart/form-data">
    <div class="container mt-md-20 mt-10 mb-0">
        @csrf
        <div class="card card-custom gutter-b">
            <div class="card-body pt-8 p-md-10 p-5">
                <h2 class="mb-10">Nueva Dirección</h2>
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <div class="form-group">
                            <label>Dirección</label>
                            <input type="text" class="form-control form-control-solid form-control-lg" name="nombre" id="direccion" required/>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                <label>Región</label>
                                <select name="bk_regiones_id" class="form-control form-control-solid form-control-lg" id="regiones" onchange="region(this.value)" required>
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                <label>Comuna</label>
                                <select name="bk_comunas_id" class="form-control form-control-solid form-control-lg" id="comunas" required>
