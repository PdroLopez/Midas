...
@section('content')
    ...
    <div class="container mt-md-20 mt-10 mb-0">
        <div class="card card-custom gutter-b">
            <div class="card-body pt-8 p-md-10 p-2">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center font-weight-bolder">
                                            <div class="symbol symbol-60 flex-shrink-0 mr-4 bg-light">
                                                <div class="symbol-label" style="background-image: url('{{ asset('public/img/solicitudes').'/'.$imagen->where('sl_solicitudes_id', $solicitud['id'])->pluck('archivo')->first() }}')">
                                                </div>
                                            </div>
                            ...
                            <tr>
                                <td colspan="4" class="border-0 text-muted text-left pt-0">Incluye retiro.</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
            ...
            <div class="row pb-10">
                ...
                <div class="col-6 text-left">
                    <a href="{{ asset('/solicitud-paso-3') }}" class="btn btn-lg btn-primary btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2">Siguiente
                    </a>
                </div>
            </div>
        </div>
