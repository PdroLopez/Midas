        ...
        <div class="col-md-8 p-lg-5 mx-auto my-5">
            <div class="row">
                <div class="col-md-6 col-10">
                    <h1 class="display-4 font-weight-normal">Agregar Acceso</h1>
                </div>
...
<form action="{{ asset('agregar-acceso') }}" method="post" files="true" enctype="multipart/form-data">
    <div class="container mt-md-20 mt-10 mb-0">
        @csrf
        <div class="card card-custom gutter-b">
            <div class="card-body pt-8 p-md-10 p-5">
                <h2 class="mb-10">Registro de Acceso</h2>
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="acceso-tab" data-toggle="tab" href="#acceso" role="tab" aria-controls="acceso" aria-selected="true">Acceso</a>
                    </li>
                </ul>
