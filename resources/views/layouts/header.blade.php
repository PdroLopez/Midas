...
<div id="kt_header" class="header header-fixed">
	<div class="container d-flex align-items-stretch justify-content-between">
		<div class="d-flex align-items-center mr-3 bar">
			<a href="{{ asset('/') }}">
				<img alt="Logo" src="{{ asset('img/midas1.png') }}" class="logo-sticky" style="width: 100px;">
			</a>
		</div>
		<div class="topbar">
...
{{-- CHAT --}}
<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4" style="top:80%;">
	<li class="nav-item" id="kt_sticky_toolbar_chat_toggler" data-toggle="tooltip" title="Chat ZOE" data-placement="left">
				...
				<div class="card card-custom">
					<div class="card-header align-items-center px-4 py-3">
						...
						<div class="text-center flex-grow-1">
							<div class="text-dark-75 font-weight-bold font-size-h5">ZOE</div>
							<div>
							...
							<div class="messages">
								<div class="d-flex flex-column mb-5 align-items-start">
									<div class="d-flex align-items-center">
										...
										<div>
											<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">ZOE</a>
											<span class="text-muted font-size-sm">Ahora</span>
										</div>
									</div>
									<div class="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px">Hola, soy Zoe, en que te puedo ayudar?</div>
								</div>
								<div class="d-flex flex-column mb-5 align-items-end">
									...
									<div class="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-400px">Hola</div>
								</div>
							</div>
						</div>
					</div>
...
{{-- ENDCHAT --}}
		...
		<div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
			<div class="offcanvas-header offcanvas-header-navs d-flex align-items-center justify-content-between mb-5" kt-hidden-height="45">
				<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-primary flex-grow-1 px-10" role="tablist">
					{{-- <li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#instagram">Instagram</a>
					</li> --}}
					<li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#tiktok">Tiktok</a>
					</li>
				</ul>
			...
			<div class="offcanvas-content px-10">
				<div class="tab-content">
					<div class="tab-pane fade pt-2 scroll ps active show ps--active-y" id="instagram" role="tabpanel" style="height: auto; overflow: auto !important;">
						<div class="mb-15">
							{{-- <div class="elfsight-app-5a3bab6d-1d7c-4043-b955-9df53e7f307b"></div> --}}
							<div class="iframely-embed"><div class="iframely-responsive" style="height: 140px; padding-bottom: 0;"><a href="https://www.instagram.com/midaschile" data-iframely-url="//cdn.iframe.ly/QDmpoTv"></a></div></div><script async src="//cdn.iframe.ly/embed.js" charset="utf-8"></script>
						</div>
					</div>
					<div class="tab-pane fade pt-2 pr-5 mr-n5 scroll ps" id="facebook" role="tabpanel" style="height: 483px; overflow: hidden;">
						<div class="mb-15">
							<h5 class="font-weight-bold mb-5">Facebook</h5>
							<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FMIDASCHILE%2F&tabs=timeline&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
						</div>
					<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px; height: 652px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div>

					<div class="tab-pane fade pt-3 pr-5 mr-n5 scroll ps" id="twitter" role="tabpanel" style="height: 483px; overflow: hidden;">
						<div class="mb-15">
							<h5 class="font-weight-bold mb-5">Twitter</h5>
							<a class="twitter-timeline"
							  href="https://twitter.com/MidasChile">
							Tweets by @MidasChile
							</a>
						</div>
						<style type="text/css">
							.brd{
					...
					<div class="tab-pane fade pt-3 pr-5 mr-n5 scroll ps" id="tiktok" role="tabpanel" style="height: 483px; overflow: hidden;">
						<div class="mb-15">
							<h5 class="font-weight-bold mb-5">Tik-Tok</h5>
							<blockquote class="embedly-card"><h4><a href="https://www.tiktok.com/@midaschile">midaschile (@midaschile) TikTok |Mira nuestros videos</a></h4><p>midaschile (@midaschile) en TikTok Reciclamos Futuro con Energías Limpias</p></blockquote>
		...
		<div id="kt_quick_actions" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 409px; overflow: auto!important;">
				...
				<div class="row gutter-b">
					<div class="col-6">
						<a href="{{ asset('/index-midas2') }}" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							<span class="svg-icon svg-icon-3x svg-icon-primary m-0">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								        <rect x="0" y="0" width="24" height="24"/>
				...
				<div class="row gutter-b">
                    ...
                    @else
                    <div class="col-6">
						<a href="{{ asset('/workflow/me') }}" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							<span class="svg-icon svg-icon-3x svg-icon-primary m-0">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24"></rect>
			...
			<div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 425px; overflow: hidden;">
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						<a href="{{ asset('/tienda/mi-cuenta') }}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::user()->name }} {{ Auth::user()->apellido}}<br> {{ Auth::user()->rol->name }}</a>
						<div class="navi mt-2">
				...
				<div>
					...
					<div class="navi navi-spacer-x-0 p-0">
                        ...
                        <a href="{{ asset('/mis-direcciones') }}/{{Auth::user()->id}}" class="navi-item">
							<div class="navi-link">
								<div class="symbol symbol-40 bg-light mr-3">
									<div class="symbol-label">
										<span class="svg-icon svg-icon-md svg-icon-warning">
								...
								<div class="navi-text">
									<div class="font-weight-bold">Mis Direcciones</div>
								</div>
							</div>
                        </a>

                        <a href="{{ asset('/mis-comunidades') }}/{{Auth::user()->id}}" class="navi-item">
							<div class="navi-link">
								<div class="symbol symbol-40 bg-light mr-3">
									<div class="symbol-label">
										<span class="svg-icon svg-icon-md svg-icon-warning">
								...
								<div class="navi-text">
									<div class="font-weight-bold">Mis Comunidades</div>
								</div>
							</div>
						</a>
						@if(count(Auth::user()->empresa_user)>0)
						<a href="{{ asset('/empresa/solicitud-retiro') }}" class="navi-item">
							<div class="navi-link">
								<div class="symbol symbol-40 bg-light mr-3">
									<div class="symbol-label">
										<span class="svg-icon svg-icon-md svg-icon-warning">
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5" style="" kt-hidden-height="40">
				<h3 class="font-weight-bold m-0">Bienvenido a Midas</h3>
				<a href="#" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_user_close">
					<i class="ki ki-close icon-xs text-muted"></i>
				</a>
			</div>
			<div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 425px; overflow: hidden;">
				<div class="d-flex align-items-center mt-5">
					<a class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5 btn-lock" href="{{ route('login') }}">Ingresa o Regístrate aquí</a>
				</div>
			</div>
		</div>
		@endif
