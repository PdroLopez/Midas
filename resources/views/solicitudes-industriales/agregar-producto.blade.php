...
<form action="{{ asset('agregar-productos-industriales') }}" method="post" files="true" enctype="multipart/form-data">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body pt-8 p-md-10 p-5">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="clasificacion" id="clasi">
