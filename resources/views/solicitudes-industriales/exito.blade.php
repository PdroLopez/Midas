        ...
        <div class="col-md-8 p-lg-5 mx-auto my-5">
            <div class="row">
                <div class="col-md-12 col-12 text-center p-3">
                    <h1 class="display-4 font-weight-normal">Solicitud Exitosa</h1>
                </div>
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body pt-8 p-md-10 p-5">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td class="font-weight-bolder font-size-h4 text-left">ID Solicitud</td>
                                <td colspan="1"></td>
                                <td class="font-weight-bolder font-size-h4 text-right">#{{ Session::get('codigo_industrial') }}</td>
                            </tr>
                            <tr>
                                ...
                                <td class="font-weight-bolder font-size-h4 text-right">
                                    @if(Session::get('empresa'))
                                        {{ Session::get('empresa') }}
                                    @else
                                        {{ Auth::user()->empresa_user->first()->empresa->nombre }}
                                    @endif  
                                </td>
                            </tr>
                            <tr>
                                <td class="font-weight-bolder font-size-h4 text-left">Marca</td>
                                <td colspan="1"></td>
                                <td class="font-weight-bolder font-size-h4 text-right">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="font-weight-bolder font-size-h4 text-left">{{ $value['nombre_grupo'] }}</td>
                                <td colspan="1"></td>
                                <td class="font-weight-bolder font-size-h4 text-right">{{ $value['nombre_clasi'] }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            <div class="row pb-10">
                <div class="col-12 text-center">
                    <a href="{{ asset('finalizar-solicitud-industrial') }}" class="btn btn-lg btn-primary btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2">Finalizar</a>
                </div>
            </div>
        </div>
    </div>
